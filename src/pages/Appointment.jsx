              ...
              <div className="appointment-form-box">
                <form className="appointment-form" name="appointment-form" action="#" method="post">
                  <div className="single-box">
                    ...
                    <div className="appointment-checkbox">
                      <div className="single-checkbox">
                        <input type="checkbox" name="your-home" id="home-1" />
                        <label htmlFor="home-1"><span />Your Home</label>
                      </div>
                      <div className="single-checkbox">
                        <input type="checkbox" name="your-business" id="your-business" defaultChecked />
                        <label htmlFor="your-business"><span />Your Business</label>    
                      </div>
                    </div>
                  </div>
                  <div className="single-box">
                    ...
                    <div className="date-box clearfix">
                      ...
                      <div className="icon">
                        <img src="/assets/images/icons/icon-64.png" alt="" />
                      </div>
                    </div>
                  </div>
                  <div className="single-box">
                  ...
                  <div className="single-box">
                    ...
                    <input type="text" name="f_name" defaultValue placeholder required />
                  </div>
                  <div className="single-box">
                    <div className="inner-title">
                      <h3>Your last name*</h3>
                    </div>
                    <input type="text" name="l_company" defaultValue placeholder />
                  </div>
                  <div className="single-box">
                    <div className="inner-title">
                      <h3>Address</h3>
                    ...
                    <div className="jobsite-address">
                      <input type="text" name="f_jobsite_address" defaultValue placeholder />
                      <input type="text" name="f_jobsite_address" defaultValue placeholder />
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-xl-4">
                      <div className="single-box">
                        ...
                        <input type="text" name="f_city" defaultValue placeholder />
                      </div>    
                    </div>
                    <div className="col-xl-4">
                    ...
                    <div className="col-xl-4">
                      <div className="single-box">
                        ...
                        <input type="text" name="f_zipcode" defaultValue placeholder />
                      </div>    
                    </div>
                  </div>
                  <div className="row">
                    <div className="col-xl-6">
                      <div className="single-box">
                        ...
                        <input type="text" name="f_jobsite_phn_number" defaultValue placeholder />
                      </div>    
                    </div> 
                    <div className="col-xl-6">
                      <div className="single-box">
                        ...
                        <input type="text" name="f_phn_number" defaultValue placeholder />
                      </div>    
                    </div>     
                  </div>
                  <div className="single-box">
                    ...
                    <input type="email" name="f_email" defaultValue placeholder required />
                  </div>
                  <div className="single-box">
                    <div className="inner-title">
                      <h3>Description</h3>
                    </div>
                    <textarea name="f_other_message" placeholder defaultValue={""} />
                  </div>
                  <div className="single-box">
                    <div className="inner-title">
                    ...
                    <div className="newsletter-checkbox">
                      <input type="checkbox" name="subscribe-newsletter" id="newsletter" defaultChecked />
                      <label htmlFor="newsletter"><span />Yes, I would like to receive occasional hints and tips via email. (Email addresses <br />will not be shared with any other company.)</label>
                    </div>
                  </div>
