const Blog = () => (
  <>
    <div className="boxed_wrapper">
      ...
      {/* page-title end */}
      {/* blog-grid */}
      <section className="blog-grid pt_120 pb_120">
        <div className="auto-container">
          <div className="row clearfix">
              ...
              <div className="news-block-two">
                <div className="inner-box">
                  <div className="image-box">
                    <figure className="image"><a href="/blog"><img src="/assets/images/news/news-7.jpg" alt="" /></a></figure>
                  ...
                  <div className="lower-content">
                    ...
                    <h3><a href="/blog-details">A Stunning Classic Modular Kitchen In Losangle</a></h3>
                    ...
                    <div className="btn-box"><a href="/blog-details" className="theme-btn">read more</a></div>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-md-6 col-sm-12 news-block">
              <div className="news-block-two">
                <div className="inner-box">
                  <div className="image-box">
                    <figure className="image"><a href="/blog"><img src="/assets/images/news/news-8.jpg" alt="" /></a></figure>
                    <div className="post-date">28<span>June</span></div>
                  </div>
                  <div className="lower-content">
                    <ul className="post-info">
                      <li>By :  <a href="/blog-details">Admin</a></li>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 news-block">
              <div className="news-block-two">
                <div className="inner-box">
                  <div className="image-box">
                    <figure className="image"><a href="/blog"><img src="/assets/images/news/news-9.jpg" alt="" /></a></figure>
                    <div className="post-date">27<span>June</span></div>
                  </div>
                  <div className="lower-content">
                    <ul className="post-info">
                      <li>By :  <a href="/blog-details">Admin</a></li>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 news-block">
              <div className="news-block-two">
                <div className="inner-box">
                  <div className="image-box">
                    <figure className="image"><a href="/blog"><img src="/assets/images/news/news-10.jpg" alt="" /></a></figure>
                    <div className="post-date">26<span>June</span></div>
                  </div>
                  <div className="lower-content">
                    <ul className="post-info">
                      <li>By :  <a href="/blog-details">Admin</a></li>
                    ...
                    <h3><a href="/blog-details">Our core values allow us to stay on track in Losangle.</a></h3>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehender.</p>
                    <div className="btn-box"><a href="/blog-details" className="theme-btn">read more</a></div>
                  </div>
                </div>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 news-block">
              <div className="news-block-two">
                <div className="inner-box">
                  <div className="image-box">
                    <figure className="image"><a href="/blog"><img src="/assets/images/news/news-11.jpg" alt="" /></a></figure>
                    <div className="post-date">25<span>June</span></div>
                  </div>
                  <div className="lower-content">
                    <ul className="post-info">
                      <li>By :  <a href="/blog-details">Admin</a></li>
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 news-block">
              <div className="news-block-two">
                <div className="inner-box">
                  <div className="image-box">
                    <figure className="image"><a href="/blog"><img src="/assets/images/news/news-12.jpg" alt="" /></a></figure>
                    <div className="post-date">24<span>June</span></div>
                  </div>
                  <div className="lower-content">
                    <ul className="post-info">
                      <li>By :  <a href="/blog-details">Admin</a></li>
          ...
          <div className="pagination-wrapper centred">
            <ul className="pagination clearfix">
              <li><a href="/blog" className="current">1</a></li>
              <li><a href="/blog">2</a></li>
              <li><a href="/blog"><i className="fas fa-angle-right" /></a></li>
            </ul>
          </div>
        </div>
      </section>
