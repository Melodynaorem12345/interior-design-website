const Testimonial = () => (
  <>
    <div className="boxed_wrapper">
      ...
      <section className="testimonial-page-section pt_130 pb_70">
        <div className="auto-container">
          <div className="row">
            <div className="col-lg-4 col-md-6 col-sm-12 title-column">
              <div className="sec-title mt_50">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12 testimonial-block">
              <div className="testimonial-block-one">
                <div className="inner-box">
                  <div className="text">
                    <div className="quote"><img src="/assets/images/icons/icon-38.png" alt="" /></div>
                    <p>Normal that has evolved from gene ration X is on the runway heading towards a streamlined cloud solution. strategies to ensure proactive domination.</p>
                  </div>
