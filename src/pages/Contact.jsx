const Contact = () => (
  <>
    <div className="boxed_wrapper">
                ...
                <nav className="main-menu navbar-expand-md navbar-light clearfix">
                  <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                    <ul className="navigation clearfix">
                      ...
                      <li className="current"><a href="/contact">Contact Us</a></li> 
                    </ul>
                  </div>
                </nav>
      ...
      {/* page-title end */}
      {/* contact-style-three */}
      <section className="contact-style-three pt_110 pb_120">
        <div className="auto-container">
          <div className="sec-title mb_50">
            <span className="sub-title mb_10">get in touch</span>
            ...
            <div className="col-lg-7 col-md-12 col-sm-12 form-column">
              <div className="form-inner">
                <form method="post" action="sendemail.php" id="contact-form">
                  ...
                  <div className="form-group message-btn pt_25">
                    <button type="submit" className="theme-btn" name="submit-form">discover more</button>
                  </div>
                </form>
              </div>
            </div>
            <div className="col-lg-5 col-md-12 col-sm-12 info-column">
              <div className="info-content ml_70">
                <h2>Our Address</h2>
                ...
                <ul className="info-list clearfix">
                  ...
                  <li>
                    <div className="icon"><img src="/assets/images/icons/icon-68.png" alt="" /></div>
                    <h5>Phone :</h5>
                    <p><a href="tel:18004567890">1800 456 7890</a> / <a href="tel:12548973654"> 1254 897 3654</a></p>
                  </li>
                  <li>
                    <div className="icon"><img src="/assets/images/icons/icon-69.png" alt="" /></div>
                    <h5>Email :</h5>
