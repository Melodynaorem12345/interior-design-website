const Service = () => (
  <>
    <div className="boxed_wrapper">
                ...
                <nav className="main-menu navbar-expand-md navbar-light clearfix">
                  <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                    <ul className="navigation clearfix">
                      ...
                      <li className="current dropdown"><a href="#">Services</a>
                        <ul>
      ...
      {/* page-title end */}
      {/* service-style-two */}
      <section className="service-style-two bg-color-2 pt_100 pb_110">
        <div className="auto-container">
          <div className="sec-title mb_60">
            <span className="sub-title mb_11">OUr services</span>
            <h2>What We Do</h2>
            <p>If you need to repair or replace your kitchen system, call today and talk to one of our Kitchen specialists. They’ll answer all your questions and arrange an appointment at your convenience.</p>
          </div>
            ...
            <div className="col-lg-3 col-md-6 col-sm-12 service-block">
              <div className="service-block-two wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                <div className="inner-box">
                  ...
                  <h3><a href="/">Kitchen <br />Designs</a></h3>
                  <div className="link"><a href="/">Learn more <img src="/assets/images/icons/icon-47.png" alt="" /></a></div>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 service-block">
              <div className="service-block-two wow fadeInUp animated" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div className="inner-box">
                  <div className="icon-box"><img src="/assets/images/icons/icon-44.png" alt="" /></div>
                  <h3><a href="/">Kitchen <br />Planner</a></h3>
                  <div className="link"><a href="/">Learn more <img src="/assets/images/icons/icon-47.png" alt="" /></a></div>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 service-block">
              <div className="service-block-two wow fadeInUp animated" data-wow-delay="400ms" data-wow-duration="1500ms">
                <div className="inner-box">
                  <div className="icon-box"><img src="/assets/images/icons/icon-45.png" alt="" /></div>
                  <h3><a href="/">Kitchen <br />Installation</a></h3>
                  <div className="link"><a href="/">Learn more <img src="/assets/images/icons/icon-47.png" alt="" /></a></div>
                </div>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 col-sm-12 service-block">
              <div className="service-block-two wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                <div className="inner-box">
                  ...
                  <h3><a href="/">Kitchen <br />Modelling</a></h3>
                  <div className="link"><a href="/">Learn more <img src="/assets/images/icons/icon-47.png" alt="" /></a></div>
                </div>
              </div>
            </div>
      ...
      {/* chooseus-section */}
      <section className="chooseus-section bg-color-2 pb_120">
        <div className="auto-container">
          <div className="row clearfix">
